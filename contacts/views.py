...
def contact(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error, 'You have already made an inquiry for this listing'
        ...
        #     'There has been an enquiry for' + listing + '. sign into the admin panel to more info',
        #     'gauravtak31@gmail.com',
        #     ['gauravtak31@gmail.com'],
        #     fail_silently=False
        # )
